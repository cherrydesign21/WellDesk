...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 cursor-pointer items-center justify-center rounded-full border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-[var(--primary-700)] active:bg-[var(--primary-800)]",
        outline:
          "border-primary bg-background text-primary hover:bg-[var(--primary-50)] aria-expanded:bg-[var(--primary-50)] dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
        secondary:
      ...
      size: {
        ...
        // primary form-submit CTAs (Sign In, Save, Create…) per the design spec.
        submit: "h-[60px] gap-1.5 px-6 text-base",
        icon: "size-8",
        "icon-xs":
