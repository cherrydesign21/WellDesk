    ...
    <Select value={value} onValueChange={(v) => onValueChange?.(v ?? "")} disabled={disabled}>
      <div className="relative">
        <SelectPrimitive.Trigger
          ...
          data-slot="select-trigger"
          className={cn(
            "peer flex h-15 w-full min-w-0 items-center justify-between gap-1.5 rounded-[6px] border bg-white px-3 pt-3 text-base outline-none transition-colors disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-input/50 disabled:opacity-50 md:text-sm [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
